...
// file except node_modules packages). Earlier versions required '../src/app' and hit
// repeated Vercel-bundler-specific failures (missing exports, CJS/ESM interop wrapping)
// that were hard to pin down from the outside. Inlining removes every cross-directory
// require from the traced dependency graph, eliminating that whole class of bundler
// ambiguity. Local dev still uses backend/src/app.js + server.js (see package.json "dev");
// this file is Vercel-only and intentionally duplicates that same logic.
